...
#ifndef _ethercatmain_WIN_H_
#define _ethercatmain_WIn_H_

#include "ethercattype.h" //add by lcj
...
//NOTE:这个是从ethercat_main.h中截取的，为了处理wpcap库和qt的网络库冲突的问题
...
#ifndef _MSC_VER //windows下不用这个结构体，因为ecx_portt会用到wpcap库，从而会造成冲突
...
#ifdef EC_VER1 //ethercattype.h中定义了EC_VER1
/** global struct to hold default master context */
#ifndef _MSC_VER //同样防止冲突
...
//下面的SOEM内部实现的头文件忽略
#ifndef _MSC_VER //ecx_redport也在wpcap库中定义
